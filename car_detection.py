...
if __name__ == '__main__':
    ...
    vs = cv2.VideoCapture(r'D:\Data_Science\iNeuron\shredder-machine-hosur\v41.mp4')
    #vs = VideoStream(0).start()

    #Oriendtation of machine    
    Orientation= 'bt'
	#input("Enter the orientation of hand progression ~ lr,rl,bt,tb :")q
   ...
   # Line_Perc1=float(15)
    ...
    try:
        while True:
            ...
            #Line_Position2 = orien_lines.drawsafelines(frame, Orientation)
            ...
            if args['display']:
                ...
                #cv2.putText(image_np, 'Number of cars ' + str(num_detections), (20, 80),
